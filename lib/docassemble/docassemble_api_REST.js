...
da.get_interview_list = async function ( timeout ) {
  /* Return the response for the list of interviews on the server. See
  ...
  *    playground is reloading the server. */
  let options = {
    method: 'GET',
    url: `${ session_vars.get_da_server_url() }/list?json=1`,
    timeout: timeout,
  };
