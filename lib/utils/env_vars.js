...
// ---- Project name ----
let repo_name_parts = env_vars.REPO_URL.split('/');
repo_name_parts.trim('/');
let repo_name = repo_name_parts[ repo_name_parts.length - 1 ];
let no_starting_digit = ( `testing${repo_name}${env_vars.BRANCH_NAME}` ).replace( /^[0-9]+/i, '' );
