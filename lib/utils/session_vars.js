...
session_vars.set_sources_folder = function(sources_folder) {
  session_vars._sources_folder = sources_folder;
};

session_vars.get_sources_folder = function() {
  return session_vars._sources_folder;
};
...
session_vars.validateEnvironment = function() {
  ...
  */
  ...
  {
    errorMessage += `\nThe sources folder must be defined. The sources folder is the path to the sources folder the contains uploadable files needed in the tests.`;
  }
