...
module.exports = {
  ...
  load: async function ( scope, file_name, attempt_num, start_time ) {
    ...
    try {
      ...
      // 1b. It's not logging anything into the console after, so it's unclear how long it takes to fail
      // 
      // 2. Attempt 2 is happening over 30 seconds later. Why is that?
      try {
      ...
      // let bodyHTML = await scope.page.evaluate(function () {
