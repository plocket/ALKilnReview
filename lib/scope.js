...
module.exports = {
  ...
  getFieldNamesDict: async function ( scope, { $ }) {
    ...
    */
    ...
    // TODO: Why are we decoding the field names here? We could decode them later, right?
   ...
   */
    ...
    let disabled = await handle.evaluate(( elem )=> {
      ...
      // TODO: remove `elem` check once we check elem existance
      // TODO: I'm not sure the below is correct
      // if ( elem && elem.disabled ) {
      //   elem.scrollIntoView(false);
      //   return true;
      // // If not disabled. What about no elem?
      // } else {
      //   return false;
      // }
      
      // TODO: bug? I think this is backwards. It's always false
      if ( elem && !elem.disabled ) {
        elem.scrollIntoView(false);
