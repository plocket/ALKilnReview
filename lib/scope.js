...
module.exports = {
  ...
  get_nav_attempt_winner: async function( scope, { elem }) {
    ...
    */
    ...
    let click_promise = elem.click()
    .then((result) => { console.log(`> clicked`); return result; })
    .catch((error) => { console.log(`click error:`, error) });
    ...
    let winner = await Promise.race([
      ...
      Promise.all([ `server_response`,  /*click_promise,*/ server_reponse_promise, dom_loaded_promise, daPageLoad_promise, /*validation code element, we hope*/ ]),  // #nav1, #nav2, #nav3, ~~#nav6 (validation should be here already if we need it)~~
