...
module.exports = {
  ...
  },  // Ends scope.afterStep()

  afterNavigation: async function() {},  // Ends scope.afterNavigation()

  afterElementInteraction: async function() {},  // Ends scope.afterElementInteraction()
