  ...
  get_nav_attempt_winner: async function( scope, { elem }) {
    ...
    *  */
    ...
    .then(async function ( response ) {
      ...
      }, data );  // ends page.evaluate

    }).then( function( data ) {

      console.log(`> page load then data:`, data);
      // data.da_page_loaded = true;
      return data;
      ...
      if (error.name === `AbortError`) {
        ...
        console.log( `Navigation other error:`, error );
      }
    });
    ...
    */
    ...
    let click_promise = elem.click().then(() => { console.log(`> click`); return `click`; });
