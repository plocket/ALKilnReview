...
module.exports = {
  ...
  addReportHeading: async function (scope, { scenario }) {
    ...
    */
    ...
    // // Collect tags with a space between them
    // let tags = '';
    let tag_names = [];
  ...
  getSafeScenarioBaseFilename: async function( scope, { scenario }) {
    ...
    */
    ...
    // // As long as it's not an empty string, add a separator
    // if ( language ) {
    //   language = `${ language.replace( /_$/, '' )}_`;
    // }
    ...
    //   tag_names.push( tag.name );
    // }
    // // As long as there are tags, make them into a string starting with `_`
    // let tags = '';
    // if ( tag_names.length > 0 ) {
    //   tags = `_${ tag_names.join('_') }`;
    // }
    ...
    // let filename = `${ language }${ name }${ tags }`;
