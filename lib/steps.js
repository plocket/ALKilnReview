...
Then(/I get the var(?:iable)? val(?:ue)?s(?: on the page)?/, async () => {
  ...
  *    to get the variable values on the page of the interview. */
  ...
  let vars_obj = await scope.page.evaluate(async function ( elem ) {
    // This extra promise wrapper is temporary until new version of core
