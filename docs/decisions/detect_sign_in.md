...
- It is pretty easy for site developers to change the HTML of standard pages.
...
- Regular interview page navigation doesn't get a 305, so this method would be a special case for signing in.
